 ...
 */const Ve=1e4,qe=`w:${oe}`,Ue="FIS_v2",tn="https://firebaseinstallations.googleapis.com/v1",nn=3600*1e3,rn="installations",an="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=/^[cdef][\w-]{21}$/,ie="";function fn(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=pn(t);return hn.test(n)?n:ie}catch{return ie}}function pn(t){return dn(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe=new Map;function Ze(t,e){const n=U(t);et(n,e),gn(n,e)}function et(t,e){const n=Xe.get(t);if(n)for(const r of n)r(e)}function gn(t,e){const n=mn();n&&n.postMessage({key:t,fid:e}),bn()}let w=null;function mn(){return!w&&"BroadcastChannel"in self&&(w=new BroadcastChannel("[Firebase] FID Change"),w.onmessage=t=>{et(t.data.key,t.data.fid)}),w}function bn(){Xe.size===0&&w&&(w.close(),w=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yn="firebase-installations-database",wn=1,v="firebase-installations-store";let Q=null;function ce(){return Q||(Q=wt(yn,wn,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(v)}}})),Q}async function j(t,e){const n=U(t),i=(await ce()).transaction(v,"readwrite"),a=i.objectStore(v),s=await a.get(n);return await a.put(e,n),await i.done,(!s||s.fid!==e.fid)&&Ze(t,e.fid),e}async function tt(t){const e=U(t),r=(await ce()).transaction(v,"readwrite");await r.objectStore(v).delete(e),await r.done}async function W(t,e){const n=U(t),i=(await ce()).transaction(v,"readwrite"),a=i.objectStore(v),s=await a.get(n),o=e(s);return o===void 0?await a.delete(n):await a.put(o,n),await i.done,o&&(!s||s.fid!==o.fid)&&Ze(t,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sn({appConfig:t,heartbeatServiceProvider:e},n){const r=kn(t,n),i=on(t,n),a=e.getImmediate({optional:!0});if(a){const c=await a.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const s={installation:{sdkVersion:qe,appId:t.appId}},o={method:"POST",headers:i,body:JSON.stringify(s)},l=await Ye(()=>fetch(r,o));if(l.ok){const c=await l.json();return ze(c)}else throw await Ke("Generate Auth Token",l)}function kn(t,{fid:e}){return`${Ge(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xn(t){const e=t,{installationEntry:n,registrationPromise:r}=await le(e);return r?r.catch(console.error):ue(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Nn(t,e=!1){const n=t;return await Mn(n),(await ue(n,e)).token}async function Mn(t){const{registrationPromise:e}=await le(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const it="installations",$n="installations-internal",Bn=t=>{const e=t.getProvider("app").getImmediate(),n=Hn(e),r=V(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Ln=t=>{const e=t.getProvider("app").getImmediate(),n=V(e,it).getImmediate();return{getId:()=>xn(n),getToken:i=>Nn(n,i)}};function jn(){H(new $(it,Bn,"PUBLIC")),H(new $($n,Ln,"PRIVATE"))}jn();M(Fe,oe);M(Fe,oe,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F="analytics",Fn="firebase_id",Vn="origin",qn=60*1e3,Un="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",de="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
