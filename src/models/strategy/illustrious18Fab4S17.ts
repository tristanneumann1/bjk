import {basicStrategyS17} from "@/models/strategy/basicStrategyS17";
import {isScenarioKey, type StrategyGrid} from "@/types/strategies";

let illustrious18Fab4S17: StrategyGrid = {
  ...basicStrategyS17,
  id: 'illustrious18Fab4S17',
  name: 'Illustrious 18 - Fab4 - S17',
}

// Illustrious 18
illustrious18Fab4S17 = {
  ...illustrious18Fab4S17,
  ...
  '12_5': [{canSplit: true, action: 'Split'}, { trueCountGreaterEqualTo: -2, action: 'Stand' }, {action: 'Hit'}],
  '12_6': [{canSplit: true, action: 'Split'}, { trueCountGreaterEqualTo: -1, action: 'Stand' }, {action: 'Hit'}],
  ...
  '20_5': [{canSplit: true, trueCountGreaterEqualTo: 5, action: 'Split'}, {action: 'Stand'}],
  '20_6': [{canSplit: true, trueCountGreaterEqualTo: 4, action: 'Split'}, {action: 'Stand'}],
}
...
// Insurance
for (const key in illustrious18Fab4S17) {
  const scenarioKey = key as keyof StrategyGrid
  if (!isScenarioKey(scenarioKey)) continue

  illustrious18Fab4S17[scenarioKey] = [{trueCountGreaterEqualTo: 3, canInsure: true, action: 'Insurance'}, ...illustrious18Fab4S17[scenarioKey]]
}

export { illustrious18Fab4S17 }
